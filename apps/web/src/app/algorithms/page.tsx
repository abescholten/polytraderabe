...
import { AlgorithmExplainer } from '@/components/algorithms/algorithm-explainer'
...
export default function AlgorithmsPage() {
  ...
  return (
    <div className="flex flex-col gap-8">
      {/* Page header */}
      <div>
        <h2 className="text-lg font-semibold text-[#e8eaed]">Trading Algoritmes</h2>
        <p className="text-sm text-[#8b8f9a]">
          Hoe ons systeem handelt op weermarkten — uitgelegd in gewone taal
        </p>
      </div>

      {/* Educational section: static algorithm explanations */}
      <AlgorithmExplainer />

      {/* Live performance section */}
      <div className="flex flex-col gap-4">
        <div>
          <h3 className="text-sm font-semibold text-[#e8eaed]">Live Prestaties</h3>
          <p className="text-xs text-[#8b8f9a]">Actieve algoritmes en hun resultaten tot nu toe</p>
        </div>
          ...
          <Card className="border-[#2e3240] bg-[#1a1d27]">
            <CardContent>
              <div className="flex flex-col items-center gap-3 py-12 text-center">
                ...
                <div>
                  <p className="text-sm text-[#e8eaed]">Geen actieve algoritmes gevonden</p>
                  <p className="text-xs text-[#8b8f9a]">
                    Algoritmes worden automatisch geregistreerd vanuit de backend configuratie
                  </p>
                </div>
              </div>
            </CardContent>
            ...
            {strategies.map((strategy) => {
              ...
              return (
                ...
                >
                  ...
                  <CardContent>
                    <p className="mb-4 line-clamp-2 text-xs text-[#8b8f9a]">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="rounded-lg bg-[#0f1117] p-2">
                        <p className="text-xs text-[#8b8f9a]">Winratio</p>
                        <p className="font-mono text-sm font-medium text-[#e8eaed]">
